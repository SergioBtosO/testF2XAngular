...
@Component({
  selector: 'f2x-form-recaudo',
  templateUrl: './form-recaudo.component.html',
  styleUrls: ['./form-recaudo.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class FormRecaudoComponent implements OnInit {
  title: string = '';
  fg: FormGroup;

  constructor(
    @Inject(MAT_DIALOG_DATA) private data: any,
    private reference: MatDialogRef<FormRecaudoComponent>
  ) {
